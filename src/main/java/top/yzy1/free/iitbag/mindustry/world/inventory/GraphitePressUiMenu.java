...
public class GraphitePressUiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GraphitePressUiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MindustryModMenus.GRAPHITE_PRESS_UI.get(), id);
