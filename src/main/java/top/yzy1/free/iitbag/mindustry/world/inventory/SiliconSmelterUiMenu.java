...
package top.yzy1.free.iitbag.mindustry.world.inventory;
...
public class SiliconSmelterUiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SiliconSmelterUiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MindustryModMenus.SILICON_SMELTER_UI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 43, 17) {
			...
			public boolean mayPlace(ItemStack stack) {
				return (MindustryModItems.COAL.get() == stack.getItem());
			}
		}));
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 43, 53) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return (MindustryModItems.SAND.get() == stack.getItem());
			}
		}));
