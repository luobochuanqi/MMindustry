...
public class SiliconSmelterGengXinYouXiKeProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (new Object() {
		...
		}.getEnergyStored(world, new BlockPos(x, y, z)) >= 30 && 9 >= new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					final int _slotid = 2;
					final ItemStack _setstack = new ItemStack(MindustryModItems.SILICON.get());
