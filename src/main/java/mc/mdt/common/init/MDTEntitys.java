...
public class MDTEntitys implements EntityRegistryContainer {
    ...
    public static EntityType<DuoTurretEntity> TURRET_DUO_ENTITY =
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, DuoTurretEntity::new)
                    .dimensions(EntityDimensions.fixed(0.7f, 0.7f))
                    .build();

    public static EntityType<TurretDuoEntity> TURRET_DUO_ENTITY_ONE =
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, createTurretDuoEntity())
                    .build();
    ...
    private static EntityType.EntityFactory<TurretDuoEntity> createTurretDuoEntity() {
        return (entityType, world) -> new TurretDuoEntity(entityType, world);
    }
